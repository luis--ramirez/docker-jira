----------------------------------------------
JIRA 7.1.9-#71013 README
----------------------------------------------

Thank you for downloading JIRA 7.1.9. This distribution comes with a
built-in Tomcat 8.0.33 application server, so it runs (almost)
out of the box.
...
2. Set the JAVA_HOME variable to where you installed Java. The Windows
   ...
   http://docs.atlassian.com/jira/jadm-docs-071/Installing+Java

3. Set your JIRA Home Directory.
   Instructions on how to set your JIRA Home Directory can be found here:

   http://docs.atlassian.com/jira/jadm-docs-071/JIRA+application+home+directory
...
http://docs.atlassian.com/jira/jadm-docs-071/Installing+JIRA
...
http://docs.atlassian.com/jira/jadm-docs-071/
